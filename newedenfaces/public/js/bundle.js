...
//import an instance of alt, not the Alt module in the npm directories itself
...
var Navbar = function (_React$Component) {
    ...
    _createClass(Navbar, [{
        ...
        value: function componentDidMount() {
            ...
            $(document).ajaxState(function () {
                _NavbarActions2.default.updateAjaxAnimation('fadeIn'); //bring in loading indicator when an AJAX request is fired
            });

            $(document).ajaxComplete(function () {
                setTimeout(function () {
                    _NavbarActions2.default.updateAjaxAnimation('fadeOut'); //remove loading indicator on completing AJAX query
                }, 750);
            });
        }
    }, {
        ...
        key: 'handleSubmit',
        value: function handleSubmit(event) {
            //submit handler for search function on the navbar
            event.preventDefault();
            ...
            if (searchQuery) {
                _NavbarActions2.default.findCharacter({
                    ...
                    history: this.props.history //pass history from App component
                });
            }
        }
    }, {
